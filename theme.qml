...
id: root
    ...
    property color menuAccentColor: "#4a9eff"
    property color menuSecondaryColor: "#252540"
    property color menuBorderColor: "#3a3a5a"
    property real menuBackgroundOpacity: 0.98
    property string menuFontFamily: bodyFont.name
    ...
    // Helper function to convert boolean settings to Yes/No strings
    function boolToYesNo(val) { return val ? "Yes" : "No" }

    // Load settings from Rift
    property var settings: {
        return {
            PlatformView:                  Rift.themeSetting("platformView") ?? "Grid",
            GridThumbnail:                 Rift.themeSetting("gridThumbnail") ?? "Dynamic Wide",
            GridColumns:                   Rift.themeSetting("gridColumns") ?? "3",
            GameBackground:                Rift.themeSetting("gameBackground") ?? "Screenshot",
            GameLogo:                      Rift.themeSetting("gameLogo") ?? "Show",
            GameRandomBackground:          boolToYesNo(Rift.themeSetting("randomizeBackground") ?? false),
            GameBlurBackground:            boolToYesNo(Rift.themeSetting("blurBackground") ?? false),
            VideoPreview:                  boolToYesNo(Rift.themeSetting("videoPreview") ?? true),
            AllowThumbVideo:               boolToYesNo(Rift.themeSetting("allowVideoThumbnails") ?? true),
            AllowThumbVideoAudio:          boolToYesNo(Rift.themeSetting("videoThumbnailAudio") ?? false),
            HideLogo:                      boolToYesNo(Rift.themeSetting("hideLogo") ?? false),
            HideButtonHelp:                boolToYesNo(Rift.themeSetting("hideButtonHelp") ?? false),
            MouseHover:                    boolToYesNo(Rift.themeSetting("mouseHover") ?? false),
            AlwaysShowTitles:              boolToYesNo(Rift.themeSetting("alwaysShowTitles") ?? false),
            AnimateHighlight:              boolToYesNo(Rift.themeSetting("animateHighlight") ?? false),
            AllowVideoPreviewAudio:        boolToYesNo(Rift.themeSetting("videoPreviewAudio") ?? false),
            ShowScanlines:                 boolToYesNo(Rift.themeSetting("showScanlines") ?? true),
            DetailsDefault:                boolToYesNo(Rift.themeSetting("defaultToFullDetails") ?? false),
            ShowcaseColumns:               Rift.themeSetting("showcaseColumns") ?? "15",
    ...
    Connections {
        ...
        function onThemeSettingChanged(key, value) {
            // Force settings object to rebuild by reading a setting
            settings = Qt.binding(function() {
                return {
                    PlatformView:                  Rift.themeSetting("platformView") ?? "Grid",
                    GridThumbnail:                 Rift.themeSetting("gridThumbnail") ?? "Dynamic Wide",
                    GridColumns:                   Rift.themeSetting("gridColumns") ?? "3",
